...
const locales = {
  ...
  DATA_IMPORT_AND_EXPORT_TOOLTIP_BASIC: $localize`Switch to Polyfolio Premium or Polyfolio Open Source easily`,
  DATA_IMPORT_AND_EXPORT_TOOLTIP_OSS: $localize`Switch to Polyfolio Premium easily`,
  DATA_IMPORT_AND_EXPORT_TOOLTIP_PREMIUM: $localize`Switch to Polyfolio Open Source or Polyfolio Basic easily`,
